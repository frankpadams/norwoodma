(()=>{
 ...
 const pages=[
  ...
  {name:'Parks & trails',url:'parks-trails.html',type:'Things to Do',text:'parks park playground playgrounds fields trail trails walking maps brochures trails advisory committee Hawes Father Macs McAleer Ellis Balch Callahan Cleveland Doherty Murphy Oldham Prescott Wilson Winslow Endean Alevizos Bernie Cooper Shattuck Hennessey Germany Brook Meadow Vanderbilt Pine Tree Forest Tiot'},
  {name:'Hiking & biking',url:'hiking-biking.html',type:'Things to Do',text:'hike hiking bike biking bicycle regional trails shops cycling clubs'},
